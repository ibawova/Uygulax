...
def MAINTENANCE():
    CreateDir('TlKLA 1','url','clear_cache',ADDON_ICON,ADDON_FANART,'')
    CreateDir('TlKLA 2','url','clear_packages',ADDON_ICON,ADDON_FANART,'')
    CreateDir('TlKLA 3','url','clear_thumbs',ADDON_ICON,ADDON_FANART,'')
